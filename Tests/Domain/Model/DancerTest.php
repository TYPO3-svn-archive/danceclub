...
/**
 * Testcase for class Tx_Danceclub_Domain_Model_Dancer.
 *
 * @version $Id$
 ...
 */
class Tx_Danceclub_Domain_Model_DancerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Danceclub_Domain_Model_Dancer
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Danceclub_Domain_Model_Dancer();
	}
